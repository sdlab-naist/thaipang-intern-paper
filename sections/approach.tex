...
\textbf{Definition:} We define a \emph{useful} comment as one that contributes to improving the proposed change, and a \emph{useless} comment as one that does not\footnote{Although we call these comments \emph{useless} in our study, it might actually be useful---or sometimes even required---in some other contexts, such as to facilitate communication or to enforce guidelines.}.

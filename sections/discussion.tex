...
This comment, \emph{``I'll study the generated code a bit more,''} is not technically contributing, but is classified as a useful comment, which may be because of the word \emph{generate} appears both documents.

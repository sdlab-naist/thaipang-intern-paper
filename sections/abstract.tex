...
\begin{abstract}
Modern Code Review (MCR)---where reviewers virtually discuss proposed changes by adding comments through a code review tool or a mailing list---has received much attention recently due to its perceived cost-effectiveness and popularity with industrial and OSS projects.
...
Our case-study results indicate that our approach can classify comments with an average F-measure score of 0.73 and reduce classification effort by about 77\%.
